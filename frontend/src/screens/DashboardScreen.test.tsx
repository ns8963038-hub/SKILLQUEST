...
describe('DashboardScreen', () => {
  it('shows level, streak, quest, and badges', async () => {
    render(<DashboardScreen onContinue={() => {}} onViewRoadmap={() => {}} onViewPlacement={() => {}} onViewDsa={() => {}} />);
  ...
  it('opens the quest level when Resume is clicked', async () => {
    ...
    render(<DashboardScreen onContinue={onContinue} onViewRoadmap={() => {}} onViewPlacement={() => {}} onViewDsa={() => {}} />);
